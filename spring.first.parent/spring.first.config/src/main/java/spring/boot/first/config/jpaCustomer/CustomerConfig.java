package spring.boot.first.config.jpaCustomer;
...
@EnableJpaRepositories(basePackages = "spring.boot.first.dao.dbCustomer", entityManagerFactoryRef = "customerEntityManager", transactionManagerRef = "transactionManager")
...
public class CustomerConfig {
	...
	public LocalContainerEntityManagerFactoryBean customerEntityManager() throws Throwable {
		...
		entityManager.setPackagesToScan("spring.boot.first.dao.dbCustomer.po");
